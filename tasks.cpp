    ...
    )
    {
        ...
        )
        {
            ...
            )
            {
                ...
                // Keep red focus after checking/unchecking
                apply_main_focus();
            }
...
static void gui_task(void)
{
    ...
    // Keep EEZ screen tick synchronized
...
void tasks_init(void)
{
    ...
    // --------------------------------------------------
    // Initialize voltage/current visibility
    // --------------------------------------------------
